...
<html>
<head>
    <title>年度全车型单车利润预算</title>
</head>
<jsp:include page="../Site/header.jsp"/>
<jsp:include page="../Site/seperator.jsp"/>
<body>
<div class="mywrapper form-group">
    <label class="control-label">年度全车型单车利润预算：</label>
    <div class="col-sm-12">
            ...
            <c:forEach items="${salesPlans}" var="salesPlan">
                ...
                <c:forEach items="${salesPlan.value}" var="sfx">
                    <tr>
                        ...
                        <c:set value="${sum22 + sfx.value.valueChainIncome}" var="sum22"/>
                        <c:set value="${sum23 + sfx.value.carBoundProfit}" var="sum23"/>
                        ...
                        <%--<td style="visibility: hidden">${sum0 += sfx.value.carCost; sum1 += sfx.value.carPrice; sum3 += sfx.value.carDiscount; sum4 += sfx.value.carProfit1;--%>
